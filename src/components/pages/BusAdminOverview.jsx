            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-lg font-bold text-gray-600">{mockStats.totalBuses}</p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg shadow p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-lg font-bold text-gray-600">₹{analyticsData.busAnalytics.totalRevenue.toLocaleString()}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-600">{analyticsData.busAnalytics.occupancyRate}%</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-600">{analyticsData.busAnalytics.averageRating}/5</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-600">₹{analyticsData.busAnalytics.maintenanceCost.toLocaleString()}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-600">{analyticsData.busAnalytics.fuelEfficiency} km/L</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  {analyticsData.routeAnalytics.popularRoutes.map((route, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div>
                        <p className="font-medium text-gray-600">{route.name}</p>
                ...
                <div className="space-y-4">
                  {analyticsData.routeAnalytics.routePerformance.map((route, index) => (
                    <div key={index} className="p-3 bg-gray-50 rounded-lg">
                      <p className="font-medium text-gray-600 mb-2">{route.name}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">Total Trips</p>
                    <p className="text-2xl font-bold text-gray-600">{analyticsData.tripAnalytics.totalTrips}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-600">{analyticsData.tripAnalytics.completedTrips}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-600">{analyticsData.tripAnalytics.cancelledTrips}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-600">{analyticsData.tripAnalytics.averageDelay} min</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-600">{analyticsData.tripAnalytics.customerSatisfaction}/5</p>
                  </div>
                </div>
              </div>
            </div>
