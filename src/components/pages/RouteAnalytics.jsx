      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-2xl font-bold" style={{color: "#B99750"}}>Route Analytics</h1>
              <p className="text-gray-600 mt-1">Performance insights and analytics for route operations</p>
            </div>
          </div>
        </div>
      </div>
