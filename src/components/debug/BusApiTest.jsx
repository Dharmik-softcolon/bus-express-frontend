      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <button onClick={fetchBuses} className="btn-primary px-4 py-2 rounded-lg border-0 hover:border-0">
              Test Get All Buses
            </button>
            <button onClick={testCreateBus} className="btn-primary px-4 py-2 rounded-lg border-0 hover:border-0">
              Test Create Bus
            </button>
            <button onClick={testUpdateBus} className="btn-secondary px-4 py-2 rounded-lg border-0 hover:border-0">
              Test Update Bus
            </button>
            ...
            <button onClick={runAllTests} className="btn-outline px-4 py-2 rounded-lg border-0 hover:border-0">
              Run All Tests
            </button>
