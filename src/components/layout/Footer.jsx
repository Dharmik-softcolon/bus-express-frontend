    ...
    <footer className="bg-navy text-white">
      <div className="container-responsive py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm sm:text-base font-semibold mb-2">Quick Links</h3>
            <ul className="space-y-1">
              <li>
                <a href="/" className="text-gray-300 hover:text-white transition-colors duration-200 text-xs sm:text-sm">
                  Home
                </a>
              </li>
              <li>
                <a href="/search" className="text-gray-300 hover:text-white transition-colors duration-200 text-xs sm:text-sm">
                  Search Buses
                </a>
              </li>
              <li>
          ...
          {/* Services */}
          <div>
            <h3 className="text-sm sm:text-base font-semibold mb-2">Services</h3>
            <ul className="space-y-1">
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors duration-200 text-xs sm:text-sm">
                  Bus Booking
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-sm sm:text-base font-semibold mb-2">Contact Info</h3>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Phone className="h-3 w-3 sm:h-4 sm:w-4 text-white flex-shrink-0" />
                <div>
                  <span className="text-gray-300 text-xs sm:text-sm block">+1 (555) 123-4567</span>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <span className="text-gray-300 text-xs sm:text-sm block break-all">info@busexpress.com</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-6 pt-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2">
            ...
            <div className="flex flex-wrap justify-center sm:justify-end gap-3">
              <a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 text-xs">
                Privacy Policy
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 text-xs">
                Terms of Service
